...
class ImageController < ApplicationController
	...
	def show
		Gabba::Gabba.new("UA-42448491-1", "stevensegallery.com").event("Images", "Show", "Size", "#{@width}x#{@height}", true)
		return_image(@width,@height)
	end

	def show_gray
		Gabba::Gabba.new("UA-42448491-1", "stevensegallery.com").event("Images", "ShowGray", "Size", "#{@width}x#{@height}", true)
